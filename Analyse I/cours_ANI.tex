...
\begin{demo}
On montre que la norme est nulle si les deux sont nuls, la norme du produit par un scalaire est le produit du scalaire avec la norme, et enfin on a l'inégalité triangulaire.\\
...
\item $x\in Fr(A)~\Leftrightarrow~\left\{x\in E;~ \forall r>0~ B(x,r)\cap A\neq \emptyset~et~ B(x,r)\cap (X\backslash A)\neq \emptyset \right\}$
\end{enumerate}
\end{propr}
