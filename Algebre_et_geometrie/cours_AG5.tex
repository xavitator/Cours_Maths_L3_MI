...
\clip(-5.15,-2.99) rectangle (5.1,4.77);
\draw (-2.28,1.46) node[anchor=north west] {$\{1\}$};
\draw (1.45,1.46) node[anchor=north west] {$\{2\}$};
\draw (-0.6,4.18) node[anchor=north west] {$\{1,2\}$};
\draw (-0.25,-1.75) node[anchor=north west] {$\emptyset$};
\draw [->] (-0.53,-1.6) -- (-1.66,0.51);
\draw [->] (0.41,-1.6) -- (1.58,0.51);
\draw [->] (1.71,1.8) -- (0.67,3.64);
\draw [->] (-1.88,1.8) -- (-0.72,3.64);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(-5.15,-2.99) rectangle (5.1,4.77);
\draw (-0.18,-1.54) node[anchor=north west] {$1$};
\draw (0.97,0.11) node[anchor=north west] {$2$};
\draw (-0.39,4.18) node[anchor=north west] {$20$};
\draw (0.92,2.36) node[anchor=north west] {$4$};
\draw (-1.5,0.15) node[anchor=north west] {$5$};
\draw (-1.64,2.42) node[anchor=north west] {$10$};
\draw [->] (-1.37,0.3) -- (-1.4,1.7);
\draw [->] (-0.2,-1.5) -- (-1.21,-0.41);
\draw [->] (0.2,-1.5) -- (1.05,-0.41);
\draw [->] (1.1,0.3) -- (1.05,1.7);
\draw [->] (0.89,0.3) -- (-1.05,1.7);
\draw [->] (-1.29,2.48) -- (-0.45,3.6);
\draw [->] (0.95,2.48) -- (0.11,3.6);
\end{tikzpicture}
\end{center}
\end{enumerate}
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(-3.55,-0.92) rectangle (3.91,3.8);
\draw [shift={(3.02,-2.43)}] plot[domain=-0.13:3.01,variable=\t]({1*5.45*cos(\t r)+0*5.45*sin(\t r)},{0*5.45*cos(\t r)+1*5.45*sin(\t r)});
\draw (-0.70,2.30) node[anchor=north west] {$x$};
\draw (2.33,3.40) node[anchor=north west] {$g.x$};
\draw [shift={(-0.24,1.58)}] plot[domain=-3.43:1.53,variable=\t]({1*0.17*cos(\t r)+0*0.17*sin(\t r)},{0*0.17*cos(\t r)+1*0.17*sin(\t r)});
\draw [->] (-0.2,1.74) -- (-0.4,1.81);
\draw (-0.12,1.48) node[anchor=north west] {$h$};
\draw (0.62,1.48) node[anchor=north west] {stabilisateur de x};
\draw (-1.59,-0.29) node[anchor=north west] {orbite de x sous G};
\draw [->] (0.34,1.20) -- (0.63,1.20);
\draw [->] (-1.89,-0.56) -- (-1.55,-0.56);
\begin{scriptsize}
\fill [color=qqqqff] (-2.38,-1.72) circle (1.5pt);
\draw[color=qqqqff] (-3.5,3.89) node {$A$};
\fill [color=qqqqff] (8.42,-3.14) circle (1.5pt);
\draw[color=qqqqff] (-3.5,3.89) node {$B$};
\fill [color=black] (-0.4,1.81) circle (3.0pt);
\end{scriptsize}
\end{tikzpicture}
\end{center}
