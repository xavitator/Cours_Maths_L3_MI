...
On fait agir le groupe $<\sigma> \subseteq \S_n$ sur $\{1,...,n\}$. Les orbites nous fournissent les cycles $c_i$, $1\leq i \leq k$
...
\begin{demo}
	On fait agir le sous-groupe $<\sigma>$ engendré par $\sigma$ dans $\S_n$ sur l'ensemble $\{1,...,n\}$.\\
...
Soit $n\geq 1$. Le groupe symétrique $\S_n$ agit sur l'ensemble $\Z[X_i,...,X_n]$ des polynômes en $\Xi_1,...,X_n$ à coefficients entiers par :
...
\begin{center}
	...
	\node (E) at (0,0) {$\{e\}$};
	\node (1234) at (-9,1.75) {$<(12)(34)>$};
	\node (1324) at (-6,1.75) {$<(13)(24)>$};
	\node (1423) at (-3,1.75) {$<(14)(23)>$};
	\node (123) at (0,3.5) {$<(123)>$};
	\node (124) at (3,3.5) {$<(124)>$};
	\node (134) at (6,3.5) {$<(134)>$};
	\node (234) at (9,3.5) {$<(234)>$};
	\node (V) at (-6,4.75) {$V$};
	\node (A4) at (0,7) {$A_4$};
